...
import { House, SquarePen, Hash, Image, Eraser, Scissors, Users, FileText, LogOut } from 'lucide-react'
...
const Sidebar = ({ sidebar, setSidebar }) => {
   ...
   return (
       <div className={`w-60 bg-white border-r border-gray-200 
            flex flex-col max-sm:absolute top-0 bottom-0 z-40 fixed h-screen
           ...
           {/* 底部操作按钮 */}
           <div className='absolute bottom-0 left-0 right-0 w-full p-4 border-t border-gray-200 bg-white flex items-center justify-between'>

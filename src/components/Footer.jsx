    ...
    return (
        <footer className="flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm text-gray-800/70">
            ...
            <div className="flex items-center gap-4 mt-8 text-indigo-500">
                ...
                <a href="https://www.linkedin.com/in/huangan-gao-bb2a622a9/" className="hover:-translate-y-0.5 transition-all duration-300">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://x.com/Gaohuangan" className="hover:-translate-y-0.5 transition-all duration-300">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://github.com/GaoHuangan" className="hover:-translate-y-0.5 transition-all duration-300">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="mt-8 text-center">Copyright © 2025 <a href="https://neuroa.ai">NeuroaAI</a>. All rights reservered.</p>
        </footer>
    )
}
